...
# These are all the get/read endpoints
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def get_player_name(player_name, db: Session = Depends(get_db)):
    player_name= db.query(Player).filter(Player.player_name == player_name).first()
    # Check if user requests player_name exists
...
@app.get("/player_name_by_id/{player_id}")
def get_player_by_id(player_id, db:Session = Depends(get_db)):
    player_name_by_id = db.query(Player).filter(Player.player_id == player_id).first()
    #if user requests an ID that doesnt exists
    if player_name_by_id is None:
        raise HTTPException(status_code=404, detail="Player not found")
    else:
        return player_name_by_id

# These are all the post/create endpoints
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# These are all the delete endpoints
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# These are all the put/update endpoints
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
